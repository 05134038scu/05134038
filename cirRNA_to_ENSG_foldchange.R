...
FC=c()
for (row in 1:length(sum_result_6ha[,1])) {
  FC[row]=as.numeric(log2((sum_result_6ha[row,3]/sum(sum_result_6ha[,3]))/(sum_result_6ha[row,2]/sum(sum_result_6ha[,2]))))
  
}
sum_result_6ha= cbind(sum_result_6ha,as.data.frame(FC))
colnames(sum_result_6ha)=c("pvalue","norm_counts_0h","norm_counts_6h","log2FoldChange")

FC2=c()
for (row in 1:length(sum_result_6ha2[,1])) {
  FC2[row]=as.numeric(log2((sum_result_6ha2[row,3]/sum(sum_result_6ha2[,3]))/(sum_result_6ha2[row,2]/sum(sum_result_6ha2[,2]))))
  
}
sum_result_6ha2= cbind(sum_result_6ha2,as.data.frame(FC2))
colnames(sum_result_6ha2)=c("pvalue","norm_counts_0h","norm_counts_6h","log2FoldChange")
...
downregulated6ha=c()
for (row in 1:length(sum_result_6ha2[,1])) {
  if (as.numeric(sum_result_6ha2[row,4]) > 0.05) {
    upregulated6ha= rbind(upregulated6ha,sum_result_6ha2[row,,drop=F])
  }  
  if (as.numeric(sum_result_6ha[row,4]) < -0.05) {
    downregulated6ha=rbind(downregulated6ha,sum_result_6ha2[row,,drop=F])
  }
}
